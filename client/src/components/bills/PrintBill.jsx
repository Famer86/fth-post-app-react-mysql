...
import React, { useRef } from "react"; //print için
import { useReactToPrint } from "react-to-print";

const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
  // cartitems parse edildi.
  const parseCartitems = customer && JSON.parse(customer.cartitems);
  ...
  return (
    <Modal
      ...
      width={800}
    >
      <section className="py-20 bg-black" ref={contentRef}>
              ...
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                ...
                <div className="text-md text-slate-500">
                  ...
                  <div>
                    ...
                    <p>{customer?.timestamps.substring(0, 10)}</p>
                  </div>
                </div>
